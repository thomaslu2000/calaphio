...
if ($g_user->is_logged_in()) {
	...
	$query = new Query(sprintf("SELECT user_id FROM %spledges_sp07 WHERE user_id=%d LIMIT 1", TABLE_PREFIX, $g_user->data['user_id']));
	...
	$is_active = !$is_pledge;
	$start_date = strtotime("2007-01-15");
	$end_date = strtotime("2007-5-18");
...
<table>
<caption>Complete 2 hours tabling - You have completed $tabling_hours hours</caption>
$tabling_events
</table>
<table>
...
<table>
<caption>Pay your \$45 active dues (\$50 after CM3, \$55 after CM5)</caption>
</table>
<table>
<caption>Complete 3 leadership credits (at least 1 must be a committee) - You can get credit by doing any of the following:</caption>
