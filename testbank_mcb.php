...
if (!$g_user->is_logged_in()) {
	...
	$files = array();
	$dir = opendir("testbank/Molecular and Cell Biology");
	while (false !== ($filename = readdir($dir))) {
		if (is_file("testbank/Molecular and Cell Biology/$filename")) {
			$files[] = $filename;
		}
	}
	natcasesort($files);
	foreach ($files as $filename) {
		...
		echo "<li><a href=\"testbank/Molecular and Cell Biology/$escaped_filename\">$escaped_filename</a></li>\n";
	}
	echo "</ul>\n";
	echo <<<HEREDOC
