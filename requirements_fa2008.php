...
if ($g_user->is_logged_in()) {
	...
	$query = new Query(sprintf("SELECT user_id FROM %spledges_fa08 WHERE user_id=%d LIMIT 1", TABLE_PREFIX, $g_user->data['user_id']));
	...
	$is_active = !$is_pledge;
	$start_date = strtotime("2008-8-18");
	$end_date = strtotime("2008-12-10");
...
<a href="requirements_sp2008.php">Spring 2008 (CC) Requirements ></a>
