...
//	trigger_error("You must be Tomo or Bonnie to access this feature", E_USER_ERROR);
	...
	$query = new Query(sprintf("SELECT apo_users.user_id, firstname, lastname, pledgeclass FROM apo_users join apo_actives_fa11 using (user_id) order by lastname, firstname"));
