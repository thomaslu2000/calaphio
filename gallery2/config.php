 ...
 */
$gallery->setConfig('setup.password', 'ggadmin');
 ...
 */
$gallery->setConfig('data.gallery.base', '/home/calaphio/g2data');
...
$storeConfig['hostname'] = 'mysql.calaphio.com';
$storeConfig['database'] = 'gallery2';
$storeConfig['username'] = 'gallery2';
$storeConfig['password'] = 'ggadmin';
