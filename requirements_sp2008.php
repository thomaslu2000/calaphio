...
if ($g_user->is_logged_in()) {
	...
	$query = new Query(sprintf("SELECT user_id FROM %spledges_sp08 WHERE user_id=%d LIMIT 1", TABLE_PREFIX, $g_user->data['user_id']));
	...
	$is_active = !$is_pledge;
	$start_date = strtotime("2008-1-14");
	$end_date = strtotime("2008-5-12");
...
<table>
<caption>Attend 2 out of 4 rush events - You have completed $rush_events_count</caption>
$rush_events
</table>
<table>
...
<table>
<caption>Pay your \$45 active dues (\$50 at CM3, \$55 at CM5)</caption>
</table>
<table>
...
<a href="requirements_fa2007.php">Fall 2007 (JCJ) Requirements ></a>
