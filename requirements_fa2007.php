...
if ($g_user->is_logged_in()) {
	...
	$query = new Query(sprintf("SELECT user_id FROM %spledges_fa07 WHERE user_id=%d LIMIT 1", TABLE_PREFIX, $g_user->data['user_id']));
	...
	$is_active = !$is_pledge;
	$start_date = strtotime("2007-08-20");
	$end_date = strtotime("2007-12-8");
...
<table>
<caption>Attend 3 rush events - You have completed $rush_events_count</caption>
$rush_events
</table>
<table>
...
<table>
<caption>Pay your \$45 active dues (\$50 after CM4, \$55 after CM6)</caption>
</table>
<table>
<caption>Complete 3 leadership credits (at least 1 must be a Sectionals committee) - You can get credit by doing any of the following:</caption>
...
<tr><td axis="name">Driving to three events</td></tr>
...
<a href="requirements_sp2007.php">Spring 2007 (MLN) Requirements ></a>
