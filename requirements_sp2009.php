...
if ($g_user->is_logged_in()) {
	...
	$query = new Query(sprintf("SELECT user_id FROM %spledges_sp2009 WHERE user_id=%d LIMIT 1", TABLE_PREFIX, $g_user->data['user_id']));
	...
	$is_active = !$is_pledge;
	$start_date = strtotime("2009-1-18");
	$end_date = strtotime("2009-5-12");
...
<a href="requirements_fa2008.php">Fall 2008 (WK) Requirements ></a>
