...
//	trigger_error("You must be Tomo or Bonnie to access this feature", E_USER_ERROR);
	...
	$query = new Query(sprintf("SELECT apo_users.user_id, firstname, lastname FROM apo_users join apo_pledges_sp12 using (user_id) where depledged=0 order by apo_users.lastname"));
