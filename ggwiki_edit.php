...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" >
	...
	<head>
		...
		function link_explanation() {
			document.getElementById("link_explanation").innerHTML = "In order to have a link on your wiki page, you need to format it in <br /><br /> LINK \"TITLE\" <br /><br /> For example: <br /><br /> http://live.calaphio.com/ggwiki.php#home \"Home Page\" <br /><br /> This will show up as <br /><br /> <font style=\"text-decoration: underline; color: blue\">Home Page</font> <br /><br /> as a link to http://live.calaphio.com/ggwiki.php#home.<br /><br /> Or you can simply copy and paste a URL on the page and that will become a link, so <br /><br /> http://live.calaphio.com/ggwiki.php#home <br /><br /> will become <br /><br /> <font style=\"text-decoration: underline; color: blue\">http://live.calaphio.com/ggwiki.php#home</font> <br /><br /> This is a bonus feature: If you put a youtube link, it will still do the same and it will automatically embed the video at the end of the article. But it will only embed one youtube video (so even if you put multiple youtube links, it will only embed the first link).";
		}
