...
if ($g_user->is_logged_in()) {
	...
	$query = new Query(sprintf("SELECT user_id FROM %spledges_sp11 WHERE user_id=%d LIMIT 1", TABLE_PREFIX, $g_user->data['user_id']));
	...
	$is_active = !$is_pledge;
	$start_date = strtotime("2010-12-1");
	$end_date = strtotime("2011-4-26");
...
<tr><td axis="name">Serving on a committee - <b>Required</b></td></tr>
...
<a href="requirements_fa2010.php">Fall 2010 (JLC) Requirements ></a>
