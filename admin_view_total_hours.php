...
<tr><td axis="semester">$fall07_dates (Fall 2007)</td> JCJ Semester<td axis="hours">$fall07</td><td axis="hours">$fall07_projects</td><td axis="hours">$fall07_fellowships</td><td axis="comments"></td></tr>
<tr><td axis="semester">$spring08_dates (Spring 2008)</td> CC Semester<td axis="hours">$spring08</td><td axis="hours">$spring08_projects</td><td axis="hours">$spring08_fellowships</td><td axis="comments"></td></tr>
<tr><td axis="semester">$fall08_dates (Fall 2008)</td> WK Semester<td axis="hours">$fall08</td><td axis="hours">$fall08_projects</td><td axis="hours">$fall08_fellowships</td><td axis="comments"></td></tr>
<tr><td axis="semester">$spring09_dates (Spring 2009)</td> ST Semester<td axis="hours">$spring09</td><td axis="hours">$spring09_projects</td><td axis="hours">$spring09_fellowships</td><td axis="comments"></td></tr>
<tr><td axis="semester">$fall09_dates (Fall 2009)</td> JM Semester<td axis="hours">$fall09</td><td axis="hours">$fall09_projects</td><td axis="hours">$fall09_fellowships</td><td axis="comments"></td></tr>
<tr><td axis="semester">$spring10_dates (Spring 2010)</td> GL Semester<td axis="hours">$spring10</td><td axis="hours">$spring10_projects</td><td axis="hours">$spring10_fellowships</td><td axis="comments"></td></tr>
<tr><td axis="semester">$fall10_dates (Fall 2010)</td> JLC Semester<td axis="hours">$fall10</td><td axis="hours">$fall10_projects</td><td axis="hours">$fall10_fellowships</td><td axis="comments"></td></tr>
