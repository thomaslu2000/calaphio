...
if ($g_user->is_logged_in()) {
	...
	$query = new Query(sprintf("SELECT user_id FROM %spledges_fa11 WHERE user_id=%d LIMIT 1", TABLE_PREFIX, $g_user->data['user_id']));
	...
	$is_active = !$is_pledge;
	$start_date = strtotime("2011-5-3");
	$end_date = strtotime("2011-11-29");
...
<table>
<caption>Attend 3 out of 6 rush events - You have completed $rush_events_count</caption>
$rush_events
</table>
<table>
...
<table>
<caption>Pay your \$45 active dues (\$55 at CM2, \$65 at CM5)</caption>
</table>
<table>
<caption>Regionals Requirement</caption>
<tr><td axis="name">Being one of the Regionals Chairs</td></tr>
<tr><td axis="name">Host a Brother</td></tr>
<tr><td axis="name">Be on Banquet Committee</td></tr>
<tr><td axis="name">Be on Finance Committee</td></tr>
<tr><td axis="name">Top T-Shirt Designs</td></tr>
<tr><td axis="name">Visit 2 IC-Chapters</td></tr>
<tr><td axis="name">Participate in a Regionals Video</td></tr>
</table>
<table>
<caption>Complete 3 leadership credits - You can get credit by doing any of the following:</caption>
<tr><td axis="name">Serving on a committee - <a href="cpz_chairs.php">Search for one here</a></td></tr>
...
<a href="requirements_sp2011.php">Spring 2011 (KS) Requirements ></a>
...
<tr><td axis="name">Join an ExComm committee - <a href="cpz_chairs.php">Search for one here</a></td></tr>
