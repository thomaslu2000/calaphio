    ...
    <div class="newsItem">
        ...
        <div class="collage-container">
            <div class="collage-pictures">
                ...
                <div class="person-picture">
                    <a href="profile.php?user_id=4608"><img src="images/excomm_f18/carol.png" onmouseover="this.src='images/excomm_f18/carol2.png'" onmouseout="this.src='images/excomm_f18/carol.png'"></img></a>
...
<?php if ($g_user->is_logged_in()): ?>
    <div class="newsItem">
        ...
        <p>Congrats to the new Excomm, and thank you to everyone that ran and sat through the whole process! Wishing the new Excomm the best of luck! Also, good luck to the pledges on finishing the rest of the semester off! Study hard and crush that 6 hour long pledge test!! Cross strong :p </p>
