...
if ($g_user->is_logged_in()) {
	...
	$query = new Query(sprintf("SELECT user_id FROM %spledges_fa10 WHERE user_id=%d LIMIT 1", TABLE_PREFIX, $g_user->data['user_id']));
	...
	$is_active = !$is_pledge;
	$start_date = strtotime("2010-5-5");
	$end_date = strtotime("2010-12-4");
...
<a href="requirements_sp2010.php">Spring 2010 (GL) Requirements ></a>
