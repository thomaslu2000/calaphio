...
if (!$g_user->is_logged_in()) {
	...
	$files = array();
	$dir = opendir("testbank/Cognitive Science");
	while (false !== ($filename = readdir($dir))) {
		if (is_file("testbank/Cognitive Science/$filename")) {
			$files[] = $filename;
		}
	}
	natcasesort($files);
	foreach ($files as $filename) {
		...
		echo "<li><a href=\"testbank/Cognitive Science/$escaped_filename\">$escaped_filename</a></li>\n";
	}
	echo "</ul>\n";
	echo <<<HEREDOC
