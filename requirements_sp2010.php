...
if ($g_user->is_logged_in()) {
	...
	$query = new Query(sprintf("SELECT user_id FROM %spledges_sp10 WHERE user_id=%d LIMIT 1", TABLE_PREFIX, $g_user->data['user_id']));
	...
	$is_active = !$is_pledge;
	$start_date = strtotime("2009-12-11");
	$end_date = strtotime("2010-4-27");
...
<a href="requirements_fa2009.php">Fall 2009 (JM) Requirements ></a>
